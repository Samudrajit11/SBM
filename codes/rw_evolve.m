function [walker_out,step_mod,varargout]=rw_evolve(obs,model,logLstar,walker_in,step_mod,varargin)
...
for i=1:nsteps
  ...
  while ~isequal(j,0)
    d_u=(rand-0.5)*rec_evoke(step_size,j);
